...
#define USART3			((USART_Typedef_t *)(USART2_BASE_ADDR) )
...
#define RCC_APB1ENR_USART2EN_Pos	(17)									// RCC APB1ENR register USART2 Bit position
#define RCC_APB1ENR_USART2EN_Msk	(0x1U << RCC_APB1ENR_USART2EN_Pos)		// RCC APB1ENR register USART2 Bit Mask
